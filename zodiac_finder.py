...
label1 = Label(root, text="WELCOME TO ZODIAC SIGN CALCULATOR", borderwidth=20, width=40, bg='black', fg='white')
label1.config(font=('Britannic Bold', 18))
label1.grid(row=0, column=0, columnspan=4)

label2 = Label(root, text="BIRTH DATE", borderwidth=10, bg='white')
label2.config(font=('Britannic Bold', 15))
label2.grid(row=1, column=1)

label3 = Label(root, text="BIRTH MONTH", borderwidth=10, bg='white')
...
get_button=Button(root, text="GET ZODIAC SIGN", anchor=CENTER, command=lambda: get_zodiac(date, month), height=3, width=20, bg="black", fg="white")
get_button.grid(row=5, column=1, columnspan=2)
